...
3. Under **Assets**, download the Windows file:
   - If it is a `.zip` file, save it to your computer
   - If it is a `.exe` file, save it to a folder you can find again
...
6. Double-click the app file to start nametag-maker.
...
1. Open the app
2. Enter the name or text you want
3. Choose a style or layout
4. Adjust size, position, or color if needed
5. Save or export the result for your montage
...
1. Start a new project or open the app
2. Type the name or tag
3. Pick a font size that matches your layout
4. Place the nametag where it fits best
5. Save the output image or project file
...
2. Check that you extracted the ZIP file before opening it
...
- `Downloads` for the original release file
- `nametag-maker` for the extracted app
- `Montage-Outputs` for saved nametags
- `Reference-Images` for source pictures
...
### Can I use it for more than montages?
